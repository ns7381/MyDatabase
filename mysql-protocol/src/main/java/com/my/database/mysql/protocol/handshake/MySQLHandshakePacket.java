...
package com.my.database.mysql.protocol.handshake;

import com.my.database.mysql.protocol.MySQLPacketPayload;
import com.my.database.mysql.protocol.constant.MySQLCapabilityFlag;
import com.my.database.mysql.protocol.constant.MySQLServerInfo;
import com.my.database.mysql.protocol.constant.MySQLStatusFlag;
