...
public class SSTableTest {
    private Descriptor desc = new Descriptor("base", "ns", "cf", new String[]{"col1", "col2"});
    private SSTableConfig config = SSTableConfig.builder()
            .setMemTablesLimit(4)
            .build();

    private SSTable sst = new SSTable(desc, "col1", config);
